...
Widget welcome4Dummy() {
  return Stack(
    children: [
      ...
      Positioned.fill(child: xGlassBgEffect(child: lockWithHeading("4) We can't wait to welcome you!", "Please pay the security deposit to unlock this step, as it helps in avoiding scam profiles and enables us to provide you with best service."))),
    ],
  );
}
